...
var y_axis_color: Color = Color(0.1, 0.1, 0.1)
...
var x_axis_position: int = 800  # Posição Y do eixo X
var y_axis_position: int = 512    # Posição X do eixo Y

# Lista de posições personalizadas para desenhar números
var number_positions: Array = [
	Vector2(960, 416),  # Ponto para o número  no eixo Y
	Vector2(1088, 576), # Ponto para o número  no eixo Y
]
